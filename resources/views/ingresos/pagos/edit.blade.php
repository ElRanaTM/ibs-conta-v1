        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="id_alumno" id="id_alumno" required
                    ...
                    <option value="{{ $pago->id_alumno }}" selected>{{ $pago->alumno->nombre_completo ?? 'N/A' }}</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="id_concepto" id="id_concepto" required
                    ...
                    <option value="{{ $pago->id_concepto }}" selected>{{ $pago->concepto->nombre ?? 'N/A' }}</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="id_periodo" id="id_periodo" required
                    ...
                    <option value="{{ $pago->id_periodo }}" selected>{{ $pago->periodo->nombre_periodo ?? 'N/A' }}</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="id_moneda" id="id_moneda" required
                    ...
                    <option value="{{ $pago->id_moneda }}" selected>{{ $pago->moneda->nombre ?? 'N/A' }}</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="id_metodo_pago" id="id_metodo_pago" required
                    ...
                    <option value="{{ $pago->id_metodo_pago }}" selected>{{ $pago->metodoPago->nombre ?? 'N/A' }}</option>
                </select>
            </div>
