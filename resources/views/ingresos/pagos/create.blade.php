            ...
            <div>
                ...
                <select name="id_concepto" id="id_concepto" required
                    ...
                    @foreach($conceptos as $concepto)
                        <option value="{{ $concepto->id_concepto }}" {{ old('id_concepto') == $concepto->id_concepto ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select name="id_metodo_pago" id="id_metodo_pago" required
                    ...
                    @foreach($metodos as $metodo)
                        <option value="{{ $metodo->id_metodo }}" {{ old('id_metodo_pago') == $metodo->id_metodo ? 'selected' : '' }}>
                            {{ $metodo->nombre }}
                        </option>
                    @endforeach
                </select>
