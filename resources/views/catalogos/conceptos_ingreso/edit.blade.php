...
@section('title', 'Editar Concepto de Ingreso')

@section('page-title', 'Editar Concepto de Ingreso')

@section('page-header')
<div class="flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Editar Concepto de Ingreso</h1>
        <p class="text-gray-600 mt-1">Modifica los datos del concepto de ingreso</p>
    </div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    <form action="{{ route('catalogos.conceptos-ingreso.update', $concepto->id_concepto) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input 
                ...
                name="monto_base" 
                id="monto_base"
                value="{{ old('monto_base', $concepto->monto_base) }}"
                step="0.01"
