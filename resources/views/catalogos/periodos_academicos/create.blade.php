...
@section('title', 'Nuevo Período Académico')
...
<div class="flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Registrar Período Académico</h1>
        <p class="text-gray-600 mt-1">Crea un nuevo período académico en el sistema</p>
    </div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    <form action="{{ route('catalogos.periodos-academicos.store') }}" method="POST" class="space-y-6">
        @csrf
